...
**版本**: v0.4.1 | **状态**: 生产就绪 🎯 | **最后更新**: 2026-04-24
...
### 最新特性（2026-04-24）
- ✅ **会话管理优化**：前端主导生成ID，消除异步竞态
- ✅ **首次对话优化**：自动创建会话并刷新侧边栏列表
- ✅ **DeepSeek风格切换**：静默切换，无冗余提示
- ✅ **日志系统瘦身**：全局删除调试日志，清爽控制台
- ✅ **流式响应修复**：EventBusAdapter正确提取payload
