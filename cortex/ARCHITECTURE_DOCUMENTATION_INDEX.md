...
| 文档 | 说明 | 状态 |
|------|------|------|
| [CORE_ENGINE_SPEC.md](./CORE_ENGINE_SPEC.md) | **核心引擎规范 v1.0** - 概念具象化、全自主执行、思维可视化、任务规划、安全授权（合并版） | ✅ **新增** |
...
**⚠️ 已归档文档（合并后不再维护）**：
- [CORE_ENGINE_IMPLEMENTATION_SPEC.md](./CORE_ENGINE_IMPLEMENTATION_SPEC.md) → 已合并至 CORE_ENGINE_SPEC.md
- [CORTEX_ULTIMATE_BLUEPRINT.md](./CORTEX_ULTIMATE_BLUEPRINT.md) → 已合并至 CORE_ENGINE_SPEC.md
- [EXISTENTIAL_MANIFESTO_SPEECH_AND_BEING.md](./archive/EXISTENTIAL_MANIFESTO_SPEECH_AND_BEING.md) → 已合并至 PHILOSOPHICAL_APPENDIX.md
- [PHILOSOPHICAL_BOUNDARIES_AND_DISILLUSIONMENT.md](./archive/PHILOSOPHICAL_BOUNDARIES_AND_DISILLUSIONMENT.md) → 已合并至 PHILOSOPHICAL_APPENDIX.md
- [AGENT_DESIGN_PHILOSOPHY.md](./archive/AGENT_DESIGN_PHILOSOPHY.md) → 已合并至 AGENT_SYSTEM_FULL_SPEC.md
- [AGENT_TECHNICAL_SPECIFICATION.md](./archive/AGENT_TECHNICAL_SPECIFICATION.md) → 已合并至 AGENT_SYSTEM_FULL_SPEC.md
- [CORE_CODE_AGENTS_SPEC.md](./archive/CORE_CODE_AGENTS_SPEC.md) → 已合并至 AGENT_SYSTEM_FULL_SPEC.md
- [FULL_STACK_HYBRID_ATTENTION_MAPPING.md](./archive/FULL_STACK_HYBRID_ATTENTION_MAPPING.md) → 已合并至 AGENT_SYSTEM_FULL_SPEC.md
- [ARCHITECTURE_CONFLICT_RESOLUTION_SPEC.md](./archive/ARCHITECTURE_CONFLICT_RESOLUTION_SPEC.md) → 已合并至 ARCHITECTURE_RISK_SPEC.md
- [ARCHITECTURE_RISK_MITIGATION_SPEC.md](./archive/ARCHITECTURE_RISK_MITIGATION_SPEC.md) → 已合并至 ARCHITECTURE_RISK_SPEC.md
